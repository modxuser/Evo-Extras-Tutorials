...
3. HOLD
4. HOLD
5. [Section 5: Modify the tagLinks Snippet]()
...
For this tutorial, the names that have been used are "single words", Aqua, Black etc. if you use names like "Light Blue" you will need to read about the changes that are required in the tagLinks snippets.
...
Find the following code in the tagLinks snippet:
