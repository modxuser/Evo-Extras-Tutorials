...
5. [Section 5: Modify the tagLinks Snippet](#section-5-modify-the-taglinks-snippet)
    - [Modify The URL Output](#modify-the-url-output)
...
We want it to create a different kind of URL, we want it to replicate a document e.g domain.com/mytags/aqua
...
If you have "End Container URL with Slash" in your Evo configuration set to yes, you need to remove the forward slash in the path in tagLinks.

If you don't remove the slash you will have two slashes in the link, the link will look something like this: mydomain.com/mytags//green

When the slash is removed from the path we get the correct output, the result looks like this: mydomain.com/mytags/green
...
If you use underscores in your alias, change the minus sign to an underscore
