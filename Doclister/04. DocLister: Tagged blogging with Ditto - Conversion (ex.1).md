...
This is the ID of the tags / category parent folder - in this case the ID is "2"

As can be seen in section 1 => step 2: [Create A Parent Folder](#create-a-parent-folder)
