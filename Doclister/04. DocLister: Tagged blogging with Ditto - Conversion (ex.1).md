...
2. [Section 2: Basic Blog Setup](#section-2-basic-blog-setup)
    - [Step 1 - Create Your Blog Parent Page](#step-1---create-your-blog-parent-page)
    - [Step 2 - Create Your Blog Pages](#step-2---create-your-blog-pages)
3. HOLD
4. HOLD
...
#### Step 1 - Create Your Blog Parent Page
...
4. Now rename the template to **BlogPost** (Template Name) and save it.
   ...
   BLOGPOSTTEMPLATEIMAGE![general](https://user-images.githubusercontent.com/1859868/113855783-b8726b80-97a0-11eb-962a-4a9edd3a245c.png)
